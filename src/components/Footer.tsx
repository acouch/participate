...
export default function Footer() {
  ...
  <footer className="bg-neutral-primary">
    <div className="mx-auto w-full max-w-screen-xl">
      <div className="px-4 py-12 bg-neutral-secondary-soft md:flex md:items-center">
        <span className="text-sm text-body sm:text-center">
          <a href="https://phillybudget.org/#about">About this website</a>
        </span>
        <span className="ms-5">|</span>
        <span className="text-sm text-body sm:text-center ms-5">
          <a href="https://phillybudget.org/#budget">About Philly's budget</a>
        </span>
        <span className="ms-5">|</span> 
        <a href="https://github.com/acouch/participate" className="text-body hover:text-heading ms-5">
